...
INSERT INTO client_details_TEMP (client_id, client_secret, client_name, dynamically_registered, refresh_token_validity_seconds, access_token_validity_seconds, id_token_validity_seconds, allow_introspection) VALUES
	...
	('7a39d78e-f091-46f1-8f0f-123518dc592f', 'MUK7NQc6H24U1pQaB_zcn5NLiTmshpSQZosIvPlydaN6Lkvvg9hndLx30cy6d3wb35VAtpHgUZAj9YC8cxhvCg', 'Play Authenticate', false, null, 3600, 600, true);
...
INSERT INTO client_scope_TEMP (owner_id, scope) VALUES
	('7a39d78e-f091-46f1-8f0f-123518dc592f', 'openid'),
	('7a39d78e-f091-46f1-8f0f-123518dc592f', 'profile'),
	('7a39d78e-f091-46f1-8f0f-123518dc592f', 'email'),
	('7a39d78e-f091-46f1-8f0f-123518dc592f', 'address'),
	('7a39d78e-f091-46f1-8f0f-123518dc592f', 'phone'),
	('7a39d78e-f091-46f1-8f0f-123518dc592f', 'offline_access');

INSERT INTO client_redirect_uri_TEMP (owner_id, redirect_uri) VALUES
	('7a39d78e-f091-46f1-8f0f-123518dc592f', 'http://localhost/'),
	('7a39d78e-f091-46f1-8f0f-123518dc592f', 'http://localhost:8080/');

INSERT INTO client_grant_type_TEMP (owner_id, grant_type) VALUES
	('7a39d78e-f091-46f1-8f0f-123518dc592f', 'authorization_code'),
	('7a39d78e-f091-46f1-8f0f-123518dc592f', 'urn:ietf:params:oauth:grant_type:redelegate'),
	('7a39d78e-f091-46f1-8f0f-123518dc592f', 'implicit'),
	('7a39d78e-f091-46f1-8f0f-123518dc592f', 'refresh_token');
--
